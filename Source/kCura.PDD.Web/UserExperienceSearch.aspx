<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserExperienceSearch.aspx.cs" Inherits="kCura.PDD.Web.UserExperienceSearch" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Performance Dashboard - User Experience Search Details</title>
...
<body>
    ...
    <div class="action-bar-secondary pivot-bar">
        ...
        <div class="varscat-report-header">
            <h1 id="ReportHeader" runat="server">Search Details Report</h1>
        </div>
                ...
                <table id="varscat-table" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th>Search</th>
                            <th>User</th>
                            <th>Percent Long-Running
                                <img src="Images/infos.png" height="12" data-placement="bottom" title="Represents the percentage of the time this search was long-running for this user and hour" /></th>
                            <th>Complex / Simple
                            ...
                            <th>Total Run Time
                                <img src="Images/infos.png" height="12" data-placement="bottom" title="The total execution time of all runs of a search by this user in the given hour, expressed in milliseconds" /></th>
                            <th>Average Run Time
                                <img src="Images/infos.png" height="12" data-placement="bottom" title="The average execution time of all runs of a search by this user in the given hour, expressed in milliseconds" /></th>
                            <th>Total Runs
                                <img src="Images/infos.png" height="12" data-placement="bottom" title="The number of times a search was run by this user in the given hour" /></th>
                            <th>QoS Hour ID
                                <img src="Images/infos.png" height="12" data-placement="bottom" title="A system identifier for this hour that can be used in EDDSPerformance table queries" /></th>
                            <th>Weekly Sample
    ...
    <input id="serverSelection" type="hidden" runat="server" />
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        varscatDetails.sources.grid = "api/UserExperienceSearch/Search/" + state.FilterConditions.CaseArtifactId;
        varscatDetails.sources.csv = "api/UserExperienceSearch/GenerateCSV/" + state.FilterConditions.CaseArtifactId;
        ...
        dt.assignFilterValue(1, state.FilterConditions.Search, state.FilterOperands.Search);
        dt.assignFilterValue(2, state.FilterConditions.User, state.FilterOperands.User);
        dt.assignFilterValue(3, state.FilterConditions.PercentLongRunning, state.FilterOperands.PercentLongRunning);
        dt.assignFilterValue(4, state.FilterConditions.FriendlyIsComplex, state.FilterOperands.IsComplex);
        dt.assignFilterValue(5, state.FilterConditions.TotalRunTime, state.FilterOperands.TotalRunTime);
        dt.assignFilterValue(6, state.FilterConditions.AverageRunTime, state.FilterOperands.AverageRunTime);
        dt.assignFilterValue(7, state.FilterConditions.NumberOfRuns, state.FilterOperands.TotalRuns);
        dt.assignFilterValue(8, state.FilterConditions.QoSHourID, state.FilterOperands.QoSHourID);
        dt.assignFilterValue(9, state.FilterConditions.FriendlyIsActiveWeeklySample, state.FilterOperands.IsActiveWeeklySample);
