namespace kCura.PDB.Data.Repositories.BISSummary
{
	...
	public class LegacyRecoverabilityIntegrityReportRepository : IRecoverabilityIntegrityReportReader, ILegacyRecoverabilityIntegrityRepository
	{
		private readonly IConnectionFactory connectionFactory;

		public LegacyRecoverabilityIntegrityReportRepository(IConnectionFactory connectionFactory)
		{
		...
		public async Task<decimal?> ReadWeekRecoverabilityIntegrityScore(Hour hour)
		{
			using (var conn = this.connectionFactory.GetEddsPerformanceConnection())
			{
				return await conn.QueryFirstOrDefaultAsync<decimal?>(Resources.RecoverabilityIntegrity_ReadWeeklyScore, new { summaryDayHour = hour.HourTimeStamp });
			}
		}
	}
}
