...
AND NOT EXISTS (SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'QoS_SystemLoadSummary' AND COLUMN_NAME = 'PoisonWaits')
BEGIN
	ALTER TABLE eddsdbo.QoS_SystemLoadSummary
	ADD PoisonWaits INT NULL
END