...
AND NOT EXISTS (SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'QoS_SystemLoadSummary' AND COLUMN_NAME = 'IsDataFile')
BEGIN
	ALTER TABLE eddsdbo.QoS_SystemLoadSummary
	ADD IsDataFile BIT NULL
END