...
AND NOT EXISTS (SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'QoS_SystemLoadSummary' AND COLUMN_NAME = 'VLFScore')
BEGIN
	ALTER TABLE eddsdbo.QoS_SystemLoadSummary
	ADD VLFScore DECIMAL(5,2) NULL
END