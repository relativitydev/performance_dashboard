...
BEGIN
	...
	IF LOWER(@SortColumn) NOT IN (N'gapsize', N'servername', N'databasename', N'isbackup', N'lastactivitydate', N'resolutiondate')
	BEGIN
	...
	DECLARE @totalRows INT = (
		...
		LEFT JOIN EDDS.eddsdbo.[Case] as c WITH(NOLOCK) on db.WorkspaceId = c.ArtifactID
		WHERE 1 = 1
		' + ISNULL(@Where, '') + '
	);
