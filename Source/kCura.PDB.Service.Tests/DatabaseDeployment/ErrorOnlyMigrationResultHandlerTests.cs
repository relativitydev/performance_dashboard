namespace kCura.PDB.Service.Tests.DatabaseDeployment
{
	...
	public class ErrorOnlyMigrationResultHandlerTests
	{
		[SetUp]
		public void Setup()
		{
			this.logger = TestUtilities.GetMockLogger();
			this.handler = new ErrorOnlyMigrationResultHandler(logger.Object);
		}

		private Mock<ILogger> logger;
		private ErrorOnlyMigrationResultHandler handler;
