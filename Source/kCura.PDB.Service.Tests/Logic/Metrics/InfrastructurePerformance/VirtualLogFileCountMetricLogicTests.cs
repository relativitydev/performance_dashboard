namespace kCura.PDB.Service.Tests.Logic.Metrics.InfrastructurePerformance
{
	...
	public class VirtualLogFileCountMetricLogicTests
	{
		private VirtualLogFileCountMetricLogic logic;
		...
		public void SetUp()
		{
			...
			this.logic = new VirtualLogFileCountMetricLogic(this.processControlRepositoryMock.Object);
		}
